    ...
    */
    ...
    const retVal: AmplifyDependentResourcesAttributes =
      AmplifyHelpers.addResourceDependency(
        ...
        [{ category: 'api', resourceName: 'batchOrderCreate' }]
      );
    ...
    const resolver = new appsync.CfnResolver(this, 'custom-resolver', {
      ...
      fieldName: 'batchOrderCreate',
      typeName: 'Mutation',
      requestMappingTemplate: appsync.MappingTemplate.fromFile(
        path.join(__dirname, '..', 'Query.testColin.req.vtl')
      ).renderTemplate(),
      responseMappingTemplate: appsync.MappingTemplate.fromFile(
        path.join(__dirname, '..', 'Query.testColin.res.vtl')
      ).renderTemplate(),
